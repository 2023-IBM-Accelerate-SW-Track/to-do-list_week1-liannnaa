...
class AddTodo extends Component {
    ...
    render() {
      return (
        ...
        <div>
          <TextField label="Add New Item" variant="outlined" data-testid="new-item-input" onChange={this.handleChange} value={this.state.content} />
          <Button style={{ marginLeft: "10px" }} variant="contained" color="primary" data-testid="new-item-button" onClick={this.handleSubmit}>  
            Add button
          </Button>
        </div>
      );
